...
public class LabeledExprParser extends Parser {
	...
	public static final int
		...
		VTYPE=54, INT=55, HEAD=56, STRING=57, BOOL=58, ID=59, LINE_COMMENT=60;
	public static final int
	...
	public static class ArraysVariableContext extends ValDeclContext {
		public TypeContext type() {
			return getRuleContext(TypeContext.class,0);
		}
		public TerminalNode ID() { return getToken(LabeledExprParser.ID, 0); }
		public TerminalNode INT() { return getToken(LabeledExprParser.INT, 0); }
		public ArraysVariableContext(ValDeclContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitArraysVariable(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ValDeclContext valDecl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				break;
			case 2:
				_localctx = new ArraysVariableContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(127);
				type();
